package cn.edu.zuel.kit.phoneRegionKit;
...
public class PhoneRegionKit {
    ...
    private static synchronized void initData() {
        if (dataByteArray == null) {
            ...
            int readBytesLength;
            try (InputStream inputStream = PhoneRegionKit.class.getClassLoader().getResourceAsStream(PHONE_DAT_FILE_PATH)) {
